...
with tf.variable_scope(reuse=None) as scope:
...
with tf.Session() as sess:
    ...
    tf.summary.histogram('weights', weights.__getitem__("wc1"))
    tf.summary.histogram('max_weight', tf.reduce_max(weights.__getitem__("wc2")))
    tf.summary.histogram('bias', biases.__getitem__("bc1"))
